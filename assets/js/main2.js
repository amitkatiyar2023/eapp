...
//         $(go.TextBlock,
//           { margin: 1, textAlign: 'center', overflow: go.TextOverflow.Ellipsis, editable: true },
...
//       myDiagram.nodeTemplate.toolTip = $('ToolTip', // show some detailed information
//         $(go.Panel,
//           'Vertical',
//           { maxSize: new go.Size(200, NaN) }, // limit width but not height
//           $(go.TextBlock, { font: 'bold 10pt sans-serif', textAlign: 'center' }, new go.Binding('text')),
//           $(go.TextBlock, { font: '10pt sans-serif', textAlign: 'center' }, new go.Binding('text', 'details'))
//         )
//       );
...
//         return [
//           $('ContextMenuButton',
//             $(go.Panel, 'Horizontal', ColorButton(colors.black), ColorButton(colors.green), ColorButton(colors.blue), ColorButton(colors.red))
//           ),
//           $('ContextMenuButton',
//             $(go.Panel, 'Horizontal', ColorButton(colors.white), ColorButton(colors.magenta), ColorButton(colors.purple), ColorButton(colors.orange))
//           ),
//         ];
//       }
...
//         // used by multiple context menus
//         return [
//           $('ContextMenuButton', $(go.Panel, 'Horizontal', ThicknessButton(1), ThicknessButton(2), ThicknessButton(3), ThicknessButton(4))),
//           $('ContextMenuButton', $(go.Panel, 'Horizontal', DashButton(null), DashButton([2, 4]), DashButton([4, 4]))),
//         ];
//       }
...
//         $('ContextMenuButton',
//           $(go.Panel, 'Horizontal', FigureButton('Rectangle'), FigureButton('RoundedRectangle'), FigureButton('Ellipse'), FigureButton('Diamond'))
//         ),
//         $('ContextMenuButton',
//           $(go.Panel, 'Horizontal', FigureButton('Parallelogram2'), FigureButton('ManualOperation'), FigureButton('Procedure'), FigureButton('Cylinder1'))
//         ),
//         $('ContextMenuButton',
//           $(go.Panel, 'Horizontal', FigureButton('Terminator'), FigureButton('CreateRequest'), FigureButton('Document'), FigureButton('TriangleDown'))
//         ),
//         LightFillButtons(),
//         DarkColorButtons(),
...
//             new go.Binding('strokeDashArray', 'dash')
//           ),
//           $(go.Placeholder, { background: 'transparent', margin: 20 })
//         ),
//         $(go.TextBlock,
//           {
...
//       myDiagram.groupTemplate.selectionAdornmentTemplate = $(go.Adornment,
//         'Spot',
//         $(go.Panel, 'Auto', $(go.Shape, { fill: null, stroke: 'dodgerblue', strokeWidth: 3 }), $(go.Placeholder, { margin: 1.5 })),
...
//         $(go.Shape, { strokeWidth: 2 }, new go.Binding('stroke', 'color'), new go.Binding('strokeWidth', 'thickness'), new go.Binding('strokeDashArray', 'dash')),
...
//       myDiagram.linkTemplate.selectionAdornmentTemplate = $(go.Adornment, // use a special selection Adornment that does not obscure the link path itself
//         $(go.Shape,
//           {
...
//       myDiagram.linkTemplate.contextMenu = $('ContextMenu',
//         DarkColorButtons(),
//         StrokeOptionsButtons(),
//         $('ContextMenuButton', $(go.Panel, 'Horizontal', ArrowButton(0), ArrowButton(1), ArrowButton(2))),
//         $('ContextMenuButton',
//           $(go.Panel,
//             'Horizontal',
//             $(go.Panel,
